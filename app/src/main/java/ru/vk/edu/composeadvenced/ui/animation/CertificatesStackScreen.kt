...
import ru.vk.edu.composeadvenced.screens.animation.CertificatesStackComponent
import ru.vk.edu.composeadvenced.ui.components.AppToolbar
import kotlin.math.roundToInt

// https://github.com/antonshilov/ComposeAnimations/blob/main/app/src/main/java/com/antonshilov/composeanimations/CertificatesStack.kt
@Composable
fun CertificatesStackScreen(component: CertificatesStackComponent) {
    Scaffold(
        topBar = {
            AppToolbar(
                title = "Стопка сертификатов",
                showBackButton = true,
...
@Composable
private fun BottomCard(transition: Transition<Boolean>, modifier: Modifier = Modifier) {
...
@Composable
private fun MiddleCard(transition: Transition<Boolean>, modifier: Modifier = Modifier) {
...
@Composable
private fun TopCard(modifier: Modifier = Modifier) {
    Box(
        modifier = modifier
            .requiredSize(340.dp, 220.dp)
...
private val TransformOriginTopCenter: TransformOrigin = TransformOrigin(0.5f, 0f)
